...
import com.example.fitness.DuplicateUserException;
...
public class AuthService {
  ...
  public record UserDto(Long id, String email, String username, String profile_pic) {
  } // Returns to client

  /* Login DTOs */
  public record LoginRequest(@NotBlank @Email String email, @NotBlank String password, String username,
      @Nullable String gID) {
  }
  ...
  private static UserDto toDto(User u) {
    return new UserDto(u.getId(), u.getEmail(), u.getUsername(), u.getProfile_pic());
  }
}
